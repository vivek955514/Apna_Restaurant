...
<body>
    ...
    if (session1 == null || (String) session1.getAttribute("userlogin") == null) {
...
%>
	...
	<form id="myform" action="ReadMenuModule" method="post">
	...
	<div class="container-xxl bg-white p-0">
		...
		<div class="container-xxl py-5">
                        ...
                        if (l != null) {
                            for (MenuPojo item : l) {
                                String cat = item.getCategory().toUpperCase();
                                 System.out.println("JSP me %%%%%%%%  MENU +++++++ category: " + cat); 
                               
                                switch (cat) {
                                    case "BREAKFAST": breakfastList.add(item); break;
                                    case "LUNCH": lunchList.add(item); break;
                                    case "DINNER": dinnerList.add(item); break;
                                }
                            }
                        }
            ...
            %>
						...
						<% System.out.println("JSP me %%%%%%%%  MENU +++++++ list: " + l);  %>
