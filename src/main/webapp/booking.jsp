                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input  name="datetime"type="text" class="form-control datetimepicker-input" id="datetime" placeholder="Date & Time" data-target="#date3" data-toggle="datetimepicker" />
                                    ...
                                    <div class="form-floating">
                                        <select class="form-select" id="people" name="people">
                                         <option value="" disabled selected>Select People</option>
                                          <option value="0">People 0</option>
