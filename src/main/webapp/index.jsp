...
<body>
	...
	<div class="container-xxl bg-white p-0">
			...
			<div class="container my-5 py-5">
				<div class="row align-items-center g-5">
					<div class="col-lg-6 text-center text-lg-start">
						...
						<p class="text-white animated slideInLeft mb-4 pb-2">At Apna-Restaurant, we serve more than just food – we serve happiness. From spicy Indian flavors to classic
						 international cuisines, our menu is crafted to satisfy every craving.</p>
						<a href=""
		...
		<div class="container-xxl py-5">
			<div class="container">
				<div class="row g-4">
					...
					<%
					String messages = (String) session.getAttribute("msg");

					if (messages == null) {
						List<ServiceModulePojo> l = (List<ServiceModulePojo>) request.getAttribute("data");

						for (ServiceModulePojo ser : l) {
					%>
					...
					<div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
						<div class="service-item rounded pt-3">
							<div class="p-4">
								...
								<i class="fa fa-3x <%=ser.getIconname()%> text-primary mb-4"></i>
								<h5><%=ser.getTitle()%></h5>
								<p><%=ser.getDescription()%></p>
							</div>
						</div>
					</div>
				...
				<div class="row g-5 align-items-center">
					...
					<div class="col-lg-6">
						<h5
							...
							Us</h5>
						<h1 class="mb-4">
							Welcome to <i class="fa fa-utensils text-primary me-2"></i>Apna-Restoran
						</h1>
		...
		<%
		if (messages == null) {
			List<MenuPojo> list = (List<MenuPojo>) request.getAttribute("data1");

			// Create category-based lists
			List<MenuPojo> breakfastList = new ArrayList<>();
			List<MenuPojo> lunchList = new ArrayList<>();
			List<MenuPojo> dinnerList = new ArrayList<>();
				...
				<div class="tab-class text-center wow fadeInUp"
					...
					<div class="tab-content">
						...
						<div id="tab-1" class="tab-pane fade show p-0 active">
							<div class="row g-4">
								<%
								for (MenuPojo item : breakfastList) {
								%>
								<div class="col-lg-6">
									<div class="d-flex align-items-center">
										<img class="flex-shrink-0 img-fluid rounded"
											src="<%=item.getImageUrl()%>" alt="<%=item.getName()%>"
											style="width: 80px;">
						...
						<div class="container">
							...
							<div class="owl-carousel testimonial-carousel">
								<div class="testimonial-item bg-transparent border rounded p-4">
									...
									<p>I loved the warm ambiance and the attention to detail. Every dish was prepared with
									 so much care. Highly recommended!"</p>
									<div class="d-flex align-items-center">
										<img class="img-fluid flex-shrink-0 rounded-circle"
											src="img/testimonial-1.jpg"
											style="width: 50px; height: 50px;">
										<div class="ps-3">
											<h5 class="mb-1">Priyanshu</h5>
											<small>Fish Chef</small>
										</div>
									</div>
								</div>
								<div class="testimonial-item bg-transparent border rounded p-4">
									<i class="fa fa-quote-left fa-2x text-primary mb-3"></i>
									<p>The chefs here are true artists! The flavors, presentation, and
									 freshness were simply outstanding.</p>
									<div class="d-flex align-items-center">
										<img class="img-fluid flex-shrink-0 rounded-circle"
